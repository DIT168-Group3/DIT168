...
class LIB_API FollowResponse {
    ...
    public:
        ...
        void accept(Visitor &visitor) {
            ...
            doVisit(1, std::move("std::string"s), std::move("ntpServerIp"s), m_ntpServerIp, visitor);
        ...
        void accept(PreVisitor &&preVisit, Visitor &&visit, PostVisitor &&postVisit) {
            ...
            doTripletForwardVisit(1, std::move("std::string"s), std::move("ntpServerIp"s), m_ntpServerIp, preVisit, visit, postVisit);
    ...
    private:
        ...
        std::string m_ntpServerIp{ ""s }; // field identifier = 1.
